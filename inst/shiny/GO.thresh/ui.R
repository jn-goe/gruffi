  ...
  shiny::sidebarLayout(
    ...
    shiny::sidebarPanel(
      if (!is.null(stress.ident1)) {
        shiny::sliderInput("t.stress.ident1", paste0("Threshold for ", ww.parse.GO(stress.ident1) ),
      ...
      if (!is.null(stress.ident2)) {
        ...
        shiny::sliderInput("t.stress.ident2", paste0("Threshold for ", ww.parse.GO(stress.ident2) ),
      ...
      if (!is.null(notstress.ident3)) {
        shiny::sliderInput("t.notstress.ident3", paste0("Threshold for ", ww.parse.GO(notstress.ident3) ),
      ...
      if (!is.null(notstress.ident4)) {
        shiny::sliderInput("t.notstress.ident4", paste0("Threshold for ", ww.parse.GO(notstress.ident4) ),
    ...
    shiny::mainPanel(shiny::tabsetPanel(
      if (!is.null(stress.ident1)) shiny::tabPanel(paste0("Histogram ", ww.parse.GO(stress.ident1)), shiny::plotOutput("hist.stress.ident1")),
      if (!is.null(stress.ident2)) shiny::tabPanel(paste0("Histogram ", ww.parse.GO(stress.ident2)), shiny::plotOutput("hist.stress.ident2")),
      if (!is.null(notstress.ident3)) shiny::tabPanel(paste0("Histogram ", ww.parse.GO(notstress.ident3)), shiny::plotOutput("hist.notstress.ident3")),
      if (!is.null(notstress.ident4)) shiny::tabPanel(paste0("Histogram ", ww.parse.GO(notstress.ident4)), shiny::plotOutput("hist.notstress.ident4")),
