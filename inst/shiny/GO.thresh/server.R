server <- shiny::shinyServer(function(input, output, session) {
  ...
  if(!is.null(stress.ident1)) {
    output$hist.stress.ident1 <- shiny::renderPlot({
      ...
      ggplot2::ggplot(df,ggplot2::aes(x=av.stress.ident1, fill=factor(assignment))) +
        ...
        ggplot2::geom_histogram(binwidth = (2*IQR(av.stress.ident1)/length(av.stress.ident1)^(1/3))) + ggplot2::theme_minimal() +
        ggplot2::geom_vline(ggplot2::aes(xintercept = quantile(av.stress.ident1, 0.9)), colour="black") + ggplot2::ylab("count") +
        ggplot2::geom_text(hjust = -.1, vjust = 10, mapping = ggplot2::aes(x = quantile(av.stress.ident1, 0.9), y = Inf, label = "90% quantile")) +
        ggplot2::coord_cartesian(xlim = c(sliders$min.x.stress.ident1, sliders$max.x.stress.ident1)) + ggplot2::xlab("GO Score") + ggplot2::guides(fill=ggplot2::guide_legend(title="assignment"))
    })
  }
  if(!is.null(stress.ident2)) {
    output$hist.stress.ident2 <- shiny::renderPlot({
      ...
      ggplot2::ggplot(df,ggplot2::aes(x=av.stress.ident2, fill=factor(assignment))) +
        ggplot2::scale_fill_manual(values=c(Seurat.utils::gg_color_hue(2)[2], Seurat.utils::gg_color_hue(2)[1])) +
        ggplot2::geom_histogram(binwidth = (2*IQR(av.stress.ident2)/length(av.stress.ident2)^(1/3))) + ggplot2::theme_minimal() +
        ggplot2::geom_vline(ggplot2::aes(xintercept = quantile(av.stress.ident2, 0.9)), colour="black") + ggplot2::ylab("count") +
        ggplot2::geom_text(hjust = -.1, vjust = 10, mapping = ggplot2::aes(x = quantile(av.stress.ident2, 0.9), y = Inf, label = "90% quantile")) +
        ggplot2::coord_cartesian(xlim = c(sliders$min.x.stress.ident2, sliders$max.x.stress.ident2)) + ggplot2::xlab("GO Score") + ggplot2::guides(fill=ggplot2::guide_legend(title="assignment"))
    })
  }
  if(!is.null(notstress.ident3)) {
    output$hist.notstress.ident3 <- shiny::renderPlot({
      ...
      ggplot2::ggplot(df,ggplot2::aes(x=av.notstress.ident3, fill=factor(assignment))) +
        ...
        ggplot2::geom_histogram(binwidth = (2*IQR(av.notstress.ident3)/length(av.notstress.ident3)^(1/3))) + ggplot2::theme_minimal() +
        ggplot2::geom_vline(ggplot2::aes(xintercept = quantile(av.notstress.ident3, 0.9)), colour="black") + ggplot2::ylab("count") +
        ggplot2::geom_text(hjust = -.1, vjust = 10, mapping = ggplot2::aes(x = quantile(av.notstress.ident3, 0.9), y = Inf, label = "90% quantile")) +
        ggplot2::coord_cartesian(xlim = c(sliders$min.x.notstress.ident3, sliders$max.x.notstress.ident3)) + ggplot2::xlab("GO Score") + ggplot2::guides(fill=ggplot2::guide_legend(title="assignment"))
    })
  }
  if(!is.null(notstress.ident4)) {
    output$hist.notstress.ident4 <- shiny::renderPlot({
      ...
      ggplot2::ggplot(df,ggplot2::aes(x=av.notstress.ident4, fill=factor(assignment))) +
        ggplot2::scale_fill_manual(values=c(Seurat.utils::gg_color_hue(2)[1], Seurat.utils::gg_color_hue(2)[2])) +
        ggplot2::geom_histogram(binwidth = (2*IQR(av.notstress.ident4)/length(av.notstress.ident4)^(1/3))) + ggplot2::theme_minimal() +
        ggplot2::geom_vline(ggplot2::aes(xintercept = quantile(av.notstress.ident4, 0.9)), colour="black") + ggplot2::ylab("count") +
        ggplot2::geom_text(hjust = -.1, vjust = 10, mapping = ggplot2::aes(x = quantile(av.notstress.ident4, 0.9), y = Inf, label = "90% quantile")) +
        ggplot2::coord_cartesian(xlim = c(sliders$min.x.notstress.ident4, sliders$max.x.notstress.ident4)) + ggplot2::xlab("GO Score") + ggplot2::guides(fill=ggplot2::guide_legend(title="assignment"))
    })
  }
  ...
  output$count.bar <- shiny::renderPlot({
    ...
    ggplot2::ggplot(c@meta.data, ggplot2::aes(x=ident.plot, fill=is.Stressed, stat = "count")) +
      ggplot2::scale_fill_manual(values=c(Seurat.utils::gg_color_hue(2)[2], Seurat.utils::gg_color_hue(2)[1])) + ggplot2::theme_minimal() +
